    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                {showAdd && <AddLinkBox onAdded={onAdd} onCancel={() => setShowAdd(false)} workspaceId={workspaceId} />}
                {showGroupAdd && <CreateGroupDialog onCreated={onAddGroup} onCancel={() => setShowGroupAdd(false)} workspaceId={workspaceId} />}
