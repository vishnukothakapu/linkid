        ...
        >
          ...
          <ScrollReveal>
            <div className="mx-auto max-w-3xl rounded-3xl border border-white/70 bg-white/70 px-6 py-12 shadow-xl shadow-violet-950/10 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04] dark:shadow-black/20 sm:px-10">
              <h2 className="text-3xl font-bold tracking-tight text-zinc-950 dark:text-white sm:text-4xl">
                {t("cta.title") || "Your professional identity, simplified."}
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-zinc-600 dark:text-zinc-300">
                {t("cta.description") || "Create your LinkID in under a minute and share one memorable URL everywhere."}
              </p>
              <div className="mt-8">
                <Button
                  size="lg"
                ...
                >
                  <Link href="/login">{t("cta.button") || "Get Started"}</Link>
                </Button>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm leading-6 text-zinc-600 dark:text-zinc-400">
                {t("footer.description") || "One identity. Infinite professional links. Built for developers who value clean, predictable URLs."}
              </p>
              <div className="pt-2">
                <LanguageSelector />
              </div>
