...
export function ProfileActionsCard({ hasPassword, profileDraft, workspaceId }: ProfileActionsCardProps) {
    ...
    async function handleCompleteMerge() {
        ...
        try {
            ...
            toast.error(error instanceof Error ? error.message : "Unable to complete merge");
        } finally {
            setLoading(false);
        }
    }
    ...
    async function handlePublishDraft() {
        ...
        try {
            ...
            toast.error(error instanceof Error ? error.message : "Unable to publish profile");
        } finally {
            setLoading(false);
        }
    }
    ...
    async function handleGeneratePreview() {
        ...
        try {
            ...
            toast.error(error instanceof Error ? error.message : "Unable to generate preview link");
        } finally {
            setLoading(false);
        }
    }
